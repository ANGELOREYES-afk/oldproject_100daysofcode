...
Bootstrap(app)
MOVIE_DB_API_KEY = '6bc047b88f669d1fb86574f06381005d93d3517a'
##CREATE DB
...
class RateMovieForm(FlaskForm):
    rating = StringField(name="Your rating: from 1-10", validators=[DataRequired()])
...
def update():
    ...
    return render_template("edit.html", movie=movie, forms=form)
...
class AddMovieForm(FlaskForm):
    Movie_title = StringField(name="Movie Title", validators=[DataRequired()])
    submit = SubmitField(name="Add Movie", validators=[DataRequired()])
